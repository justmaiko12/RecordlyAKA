...
interface RendererRecordingRunAudit {
  ...
  summary: {
    ...
    proofMonotonic: boolean | null;
    rendererPreviewIssueCount: number;
    screenWriterStatus: string | null;
    screenDuration: number | null;
    screenFrames: number | null;
    webcamWriterStatus: string | null;
    webcamDuration: number | null;
    webcamFrames: number | null;
...
interface RendererNativeWebcamPreviewState {
  active: boolean;
...
interface RendererNativeWebcamPreviewStartOptions {
...
interface RendererNativeWebcamPreviewStopOptions {
  reason?: "renderer-stop" | "recording-start";
}

interface RendererNativeWebcamPreviewRendererIssuePayload {
  surface?: string;
  issue?: string;
...
type RendererNativeWebcamPreviewStartResult =
  | {
      success: true;
      streamUrl: string;
      snapshotUrl: string;
...
interface Window {
  electronAPI: {
    ...
    sceneStyleToggle: (payload: {
      timeMs: number;
      mode: "fill" | "framed";
    }) => void;
    onSceneStyleHotkey: (
      callback: (mode: "fill" | "framed") => void,
    ) => () => void;
    ...
    getVideoDeviceConnectionInfo: () => Promise<{
      success: boolean;
      devices: Array<{
        label: string;
    ...
    getAudioDeviceConnectionInfo: () => Promise<{
      success: boolean;
      devices: Array<{
        label: string;
        normalizedLabel: string;
    ...
    startNativeScreenRecording: (
      ...
      webcamStartOffsetMs?: number | null;
      recordingStartLeadMs?: number | null;
      message?: string;
      error?: string;
    ...
    onNativeWebcamPreview: (
      callback: (state: RendererNativeWebcamPreviewState) => void,
    ) => () => void;
    startNativeWebcamPreview: (
      options?: RendererNativeWebcamPreviewStartOptions,
    ) => Promise<RendererNativeWebcamPreviewStartResult>;
    stopNativeWebcamPreview: (
      options?: RendererNativeWebcamPreviewStopOptions,
    ) => Promise<{ success: boolean; stopped: boolean }>;
    reportNativeWebcamPreviewRendererIssue: (
      payload: RendererNativeWebcamPreviewRendererIssuePayload,
    ) => Promise<{
      success: boolean;
      recorded?: boolean;
      reason?: string;
    ...
    setCurrentVideoPath: (
      ...
      options?: {
        ...
        source?:
          ...
          | "recording-background-finalization"
          | "user-open";
      },
    ) => Promise<{
      success: boolean;
    ...
    finishWebcamSidecarRecording?: (streamId: string) => Promise<{
      success: boolean;
      path?: string;
      bytesWritten?: number;
      chunksWritten?: number;
      ...
      normalizedBytesWritten?: number;
      error?: string;
    }>;
    abortWebcamSidecarRecording?: (
      streamId: string,
      reason?: string | null,
    ) => Promise<{
      success: boolean;
